  ...
  // ── ビジネス・経済 ────────────────────────────────────────────────────────
  {
    ...
    subcategories: [
      c("workstyle", "仕事術", ["仕事術", "生産性", "働き方"], [
        c("task-management", "タスク管理", ["タスク管理", "todo", "gtd", "段取り", "タスク", "優先順位", "整理術", "業務管理", "仕事管理"]),
        c("time-management", "時間管理", ["時間管理", "タイムマネジメント", "時短", "時間術", "スケジュール", "効率化", "朝活"]),
        c("focus", "集中力", ["集中力", "先延ばし", "ルーティン", "集中する", "深い仕事", "フォーカス", "ディープワーク"]),
        c("meeting-doc", "会議・資料作成", ["会議", "議事録", "資料作成", "スライド", "プレゼン資料", "報告書", "会議術"]),
        c("team-practice", "チーム実務", ["チーム", "実務", "連携", "業務改善", "チームワーク", "協働", "報連相"]),
      ]),
      c("thinking", "思考法", ["思考法", "論理", "問題解決", "フレームワーク"], [
        c("logical-thinking", "ロジカルシンキング", ["ロジカル", "論理思考", "mece", "ロジカルシンキング", "論理的", "フレームワーク", "論理力", "思考整理", "クリティカル"]),
        c("problem-solving", "問題解決", ["問題解決", "課題解決", "ボトルネック", "課題設定", "問題分析", "解決策", "改善策"]),
        c("decision-making", "意思決定", ["意思決定", "判断", "選択", "決断", "判断力", "決断力", "判断基準"]),
        c("hypothesis", "仮説思考", ["仮説", "仮説思考", "検証", "仮説検証", "データ思考"]),
        c("explanation", "伝達・説明", ["説明", "伝え方", "図解", "プレゼン", "伝える力", "説明力", "プレゼン力", "わかりやすく"]),
      ]),
      c("management", "経営", ["経営", "事業", "組織", "経営戦略"], [
        c("business-strategy", "経営戦略", ["経営戦略", "競争優位", "戦略", "ポーター"],
          undefined, { strongKeywords: ["競争戦略", "戦略立案", "中期経営計画", "事業戦略", "業界分析", "競合分析"] }),
        c("org-management", "組織マネジメント", ["組織", "マネジメント", "チーム"],
          undefined, { strongKeywords: ["組織変革", "組織開発", "チームビルディング", "組織文化", "組織マネジメント", "組織づくり"] }),
        c("leadership", "リーダーシップ", ["リーダー", "リーダーシップ", "管理職", "部下", "上司", "コーチング", "メンバー育成", "影響力"]),
        c("hr-system", "人事・制度", ["人事", "制度", "評価", "採用", "人材育成", "評価制度", "採用活動", "人事戦略"]),
        c("biz-planning", "事業企画", ["事業企画", "企画", "kpi", "新規事業計画", "事業計画", "ビジネスプラン", "事業構想"]),
      ]),
      c("marketing", "マーケティング", ["マーケティング", "セールス", "顧客", "ブランド"], [
        c("brand", "ブランド", ["ブランド", "ブランディング", "ブランド価値", "ブランドイメージ", "ブランド戦略"]),
        c("digital-marketing", "デジタルマーケティング", ["デジタルマーケティング", "web広告", "seo", "デジタル", "web", "オンライン", "ネット広告", "コンテンツマーケ"]),
        c("sns-content", "SNS・コンテンツ", ["sns", "コンテンツ", "発信", "youtube", "インスタグラム", "tiktok", "フォロワー", "バズ", "twitter", "x"]),
        c("sales", "セールス", ["営業", "セールス", "商談", "営業力", "商談力", "受注", "売上", "顧客獲得", "提案力"]),
        c("customer-insight", "顧客理解", ["顧客理解", "インサイト", "ペルソナ", "cx", "顧客調査", "ユーザーリサーチ", "ニーズ", "顧客の声"]),
      ]),
      c("finance", "会計・ファイナンス", ["会計", "簿記", "財務", "ファイナンス"], [
        c("bookkeeping", "簿記・会計", ["簿記", "会計", "仕訳", "財務諸表", "貸借対照表", "損益計算書", "決算書", "b/s"]),
        c("managerial-accounting", "管理会計", ["管理会計", "原価", "予算管理", "コスト削減", "利益管理", "損益", "収支分析"]),
        c("corporate-finance", "コーポレートファイナンス", ["企業価値", "dcf", "資本コスト", "企業価値評価", "m&a", "バリュエーション", "irr"]),
        c("investment-decision", "投資判断", ["投資判断", "npv", "roi", "投資分析", "リターン"]),
        c("personal-finance", "家計・資産管理", ["家計", "資産管理", "fp", "お金の管理", "家計術", "fp資格"]),
      ]),
      c("career", "キャリア", ["キャリア", "転職", "副業"], [
        c("job-change", "転職", ["転職", "職務経歴", "面接", "転職活動", "求人", "職務経歴書", "面接対策"]),
        c("workstyle-career", "働き方", ["働き方", "リモート", "ワークスタイル", "テレワーク", "在宅", "リモートワーク", "働き方改革"]),
        c("career-design", "キャリア設計", ["キャリア設計", "キャリア形成", "キャリアプラン", "将来設計", "長期的なキャリア"]),
        c("side-business", "副業", ["副業", "複業", "フリーランス", "副収入", "独立起業", "自分のビジネス"]),
        c("manager-practice", "マネージャー実務", ["マネージャー", "1on1", "評価", "フィードバック", "評価面談", "マネジメント実務"]),
      ]),
      c("startup", "起業", ["起業", "スタートアップ", "独立"], [
        c("startup-intro", "起業入門", ["起業入門", "起業", "会社設立", "起業の始め方", "創業", "起業家"]),
        c("new-business", "新規事業", ["新規事業", "事業開発", "事業立ち上げ", "ビジネスモデル", "事業化", "アイデア実現"]),
        c("pmf-growth", "PMF・グロース", ["pmf", "グロース", "成長戦略", "グロースハック", "ユーザー獲得", "成長軌道"]),
        c("fundraising", "資金調達", ["資金調達", "vc", "ピッチ", "投資家", "シード", "エンジェル投資家"]),
        c("independent-practice", "独立実務", ["独立", "個人事業", "営業", "請求", "フリーランス業務", "個人事業主", "自営業"]),
      ]),
    ],
  },
  ...
  // ── 自己啓発 ─────────────────────────────────────────────────────────────
  {
    ...
    subcategories: [
      c("habit", "習慣", ["習慣", "継続", "行動", "習慣化"], [
        c("habit-formation", "習慣化", ["習慣化", "継続", "ルーティン", "習慣", "習慣を作る", "毎日の習慣", "習慣術", "行動習慣"]),
        c("motivation", "モチベーション", ["モチベーション", "やる気", "意欲", "やる気を出す", "モチベ管理", "内発的動機"]),
      ]),
      c("mindset", "マインドセット", ["マインドセット", "自己理解", "思考習慣"], [
        c("self-understanding", "自己理解", ["自己理解", "自己分析", "強み", "自分を知る", "自分の強み", "内省"]),
        c("wellbeing", "幸福論", ["幸福", "ウェルビーイング", "幸せ", "豊かさ", "幸福感", "人生の豊かさ", "充実した人生"]),
      ]),
      c("communication", "コミュニケーション", ["対話", "交渉", "プレゼン", "コミュニケーション"], [
        c("listening", "対話・傾聴", ["傾聴", "対話", "質問力", "聞く力", "アクティブリスニング", "対話力"]),
        c("negotiation", "説得・交渉", ["説得", "交渉", "合意形成", "交渉術", "ネゴシエーション", "win-win"]),
        c("presentation", "プレゼン", ["プレゼン", "発信", "話し方", "プレゼンテーション", "スピーチ", "話す力"]),
      ]),
      c("learning", "学び方", ["学習法", "記憶", "勉強法", "読書術"], [
        c("study-method", "学習法", ["学習法", "勉強法", "学び方", "独学", "自習", "効率的な勉強", "学習効率"]),
        c("memory", "記憶法", ["記憶法", "暗記", "記憶術", "記憶力", "覚える方法", "忘れない"]),
      ]),
      c("life", "生き方", ["人生", "人生設計", "生き方", "ライフスタイル"], [
        c("life-design", "人生設計", ["人生設計", "ライフデザイン", "キャリア観", "人生計画", "理想の人生", "ライフプラン"]),
      ]),
    ],
  },
  ...
  // ── 心理学・行動科学 ─────────────────────────────────────────────────────
  {
    ...
    subcategories: [
      c("behavioral-econ", "行動経済学", ["行動経済学", "意思決定", "バイアス", "ヒューリスティック"], [
        c("bias", "バイアス", ["バイアス", "ヒューリスティック", "認知バイアス", "思考のクセ", "心理的バイアス", "無意識の偏り"]),
        c("decision", "意思決定", ["意思決定", "判断", "選択バイアス", "合理的判断", "直感と論理"]),
      ], { requiredAny: ["行動経済学", "バイアス", "ヒューリスティック", "意思決定科学"] }),
      c("cognitive", "認知心理学", ["認知心理", "学習", "記憶", "知覚"], [
        c("learning-memory", "学習・記憶", ["学習", "記憶", "認知", "認知科学", "記憶術", "学習効果", "認知的"]),
      ], { requiredAny: ["認知", "認知心理", "認知科学", "知覚"] }),
      c("neuroscience", "脳科学", ["脳科学", "脳", "神経", "神経科学"], [
        c("habit-build", "習慣形成", ["習慣形成", "習慣化", "脳の仕組み", "脳科学的", "神経回路", "脳内メカニズム"]),
      ], { requiredAny: ["脳科学", "脳", "神経", "神経科学"] }),
      c("mental-care", "メンタルケア", ["ストレス", "メンタル", "感情", "不安", "うつ"], [
        c("stress", "ストレス", ["ストレス", "不安", "回復", "レジリエンス", "ストレス解消", "心の回復", "燃え尽き", "バーンアウト"]),
        c("emotion", "感情", ["感情", "情動", "セルフケア", "感情調整", "感情コントロール", "感情知性", "eq"]),
      ], { requiredAny: ["メンタル", "ストレス", "感情", "不安", "うつ", "精神"] }),
      c("social-psych", "対人心理", ["対人", "説得", "人間関係", "社会心理"], [
        c("persuasion", "説得", ["説得", "影響力", "説得心理", "説得術", "行動を変える", "影響を与える"]),
        c("relationships", "人間関係", ["人間関係", "対人関係", "社会的影響", "人間心理", "他者理解", "コミュニケーション心理"]),
  ...
  // ── 歴史・社会 ───────────────────────────────────────────────────────────
  {
    ...
    subcategories: [
      c("world-history", "世界史", ["世界史", "文明", "地政学", "帝国史"], [
        c("ancient", "古代", ["古代", "古代文明", "ローマ", "ギリシャ", "古代史", "古代ローマ", "ギリシャ文明", "古代エジプト"]),
        c("medieval", "中世", ["中世", "中世史", "十字軍", "中世ヨーロッパ", "封建", "騎士"]),
        c("modern", "近代", ["近代", "帝国", "産業革命", "近代史", "植民地", "近代化", "フランス革命"]),
        c("contemporary", "現代", ["現代", "冷戦", "グローバル", "20世紀", "現代史", "二次世界大戦", "冷戦史"]),
      ]),
      c("japanese-history", "日本史", ["日本史", "戦国", "幕末", "戦後", "明治"], [
        c("sengoku", "戦国・幕末", ["戦国", "幕末", "維新", "江戸幕府", "戦国時代", "幕末期", "明治維新"]),
        c("postwar", "戦後", ["戦後", "昭和", "平成", "戦後日本", "高度経済成長", "バブル", "昭和史"]),
      ]),
      c("politics", "政治・制度", ["政治", "制度", "政策", "行政"], [
        c("policy", "政策", ["政策", "行政", "制度設計", "法律", "政治制度", "公共政策", "法制度"]),
      ]),
      c("social-issue", "社会課題", ["社会問題", "格差", "少子化", "貧困"], [
        c("social-problem", "社会問題", ["社会問題", "格差", "貧困", "差別", "少子化問題", "高齢化", "社会格差"]),
      ]),
      c("global", "環境・国際", ["sdgs", "環境", "国際", "国際関係", "外交"], [
        c("sdgs", "SDGs", ["sdgs", "サステナビリティ", "気候変動", "環境問題", "脱炭素", "持続可能", "環境保護"]),
        c("international", "国際関係", ["国際関係", "外交", "国連", "地政学", "国際政治", "外交政策", "安全保障"]),
      ]),
    ],
  },
  ...
  // ── 科学・教養 ───────────────────────────────────────────────────────────
  {
    ...
    subcategories: [
      c("physics-space", "物理・宇宙", ["物理", "宇宙", "量子", "相対性理論", "素粒子"], [
        c("quantum", "量子", ["量子", "素粒子", "量子力学", "量子コンピュータ", "量子論", "量子物理", "量子技術"]),
        c("space", "宇宙", ["宇宙", "天文学", "銀河", "ブラックホール", "惑星", "宇宙論", "天体", "星座"]),
      ], { requiredAny: ["物理", "宇宙", "量子", "天文", "素粒子", "相対性理論"] }),
      c("bio-med", "生物・医学", ["生物", "遺伝", "人体", "医学", "生命"], [
        c("evolution", "進化", ["進化", "生態", "進化論", "自然選択", "生物進化", "ダーウィン", "種の起源"]),
        c("genetics", "遺伝", ["遺伝", "dna", "ゲノム", "遺伝子工学", "遺伝情報", "遺伝子編集", "クリスパー"]),
        c("human-body", "人体", ["人体", "解剖", "脳", "生理学", "人体の仕組み", "臓器", "免疫", "身体"]),
      ], { requiredAny: ["生物", "遺伝", "進化", "医学", "生命科学", "ゲノム", "dna"] }),
      c("math-stats", "数学・統計", ["数学", "統計", "確率", "線形代数", "微積分"], [
        c("statistics", "統計", ["統計", "回帰", "仮説検定", "統計学", "統計分析", "データ統計", "統計的"]),
        c("probability", "確率", ["確率", "確率論", "確率変数", "確率的", "ベイズ", "期待値"]),
        c("linear-algebra", "線形代数", ["線形代数", "行列", "ベクトル", "行列計算", "固有値", "線型"]),
      ], { requiredAny: ["数学", "統計学", "確率", "線形代数", "微積分", "数理"] }),
      c("general-education", "一般教養", ["教養", "科学読み物", "サイエンス", "科学エッセイ"], [
        c("math-literacy", "数学教養", ["数学教養", "数理思考", "数学的思考", "数学入門", "数学の面白さ", "日常の数学"]),
        c("science-reading", "科学読み物", ["科学読み物", "科学エッセイ", "ポピュラーサイエンス", "サイエンス読み物", "科学の最前線"]),
      ]),
    ],
  },
