...
const L2_SEO: Record<string, { title: string; desc: string; longDesc: string }> = {
  ...
  fantasy: {
    title: "ファンタジー小説おすすめ厳選｜2026年版 異世界・魔法・冒険の名作",
    desc: "ファンタジー小説おすすめ一覧。異世界転生・魔法・冒険の名作から話題作まで厳選。Kindle Unlimited対応多数。初心者でも選びやすいジャンル別ガイド付き。",
    longDesc: "異世界転生・魔法・ドラゴン・英雄譚など壮大な世界観のファンタジー小説を厳選しました。王道冒険ファンタジーからダークファンタジー・神話伝承系まで幅広く揃えています。「どの作品から読む？」初心者でも選びやすい作品が見つかります。"
  },
  romance: {
