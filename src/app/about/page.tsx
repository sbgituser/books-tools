        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-6 sm:p-8 shadow-sm space-y-8">
          ...
          <section>
            ...
            <p className="text-sm text-stone-700 leading-relaxed">
              ...
              気分・シーン・ジャンル・映像化・読む順番など多様な切り口で本を探せるツールと情報を提供するサイトです。
              漫画・小説・ビジネス書など幅広いジャンルを対象に、
              作品データ・ジャンル・読書体験タグ・関連作品との比較をもとに紹介しています。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-stone-700 leading-relaxed">
              Books Tools の記事・一覧は、作品データ、ジャンル分類、読書体験タグ、関連作品との比較をもとに構成しています。
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-stone-600 leading-relaxed">
                  おすすめ記事で紹介する作品は、作品データ・ジャンル・読書体験タグ・関連作品との比較をもとに選定しています。
                  読みやすさ、完結状況、ジャンル適合度、読後感、初心者向け度を選定基準としています。
                </p>
              </div>
              <div>
                <h3 className="text-base font-semibold text-stone-700 mb-1">
              ...
              <div>
                ...
                <p className="text-sm text-stone-600 leading-relaxed">
                  記事の作成にはAIツールを活用しています。その際も、
                  架空のレビュー・架空の体験談・架空の引用・事実未確認の断定は作成しません。
                  作品データと公開情報にもとづく記述を基本としています。
                </p>
              </div>
              <div>
                <h3 className="text-base font-semibold text-stone-700 mb-1">
